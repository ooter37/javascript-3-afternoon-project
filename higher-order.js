...
//why let orderTotals // Code here
//doesnt let orderTotals = orders.map(function(i) {
//this  i.price * (1 + i.tax)
//work?! })
let orderTotals = orders.map(i => i.price * (1 + i.tax))
...
let bobsArray = purchases.filter(value => value.owner === 'Bob')
let bobsTotal = bobsArray.reduce(function (acc, element) {return acc + element.price; }, 0)